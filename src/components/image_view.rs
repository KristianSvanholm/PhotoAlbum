...
use std::io::Read;
use std::ops::Not;
use crate::components::upload::img_from_bounds;
...
#[component]
fn users_in_picture<W>(image_id: W, imgb64: String) -> impl IntoView
where
    W: Fn() -> String + Copy + 'static,
{
