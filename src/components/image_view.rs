                ...
                <For
                    ...
                    <button class="edit_persons" 
                        on:click=move |_| {
                            logging::log!("Add");
                            set_people.update(|people|{
                                people.push("".to_string());
                            })
                        }><i class="fas fa-plus"></i>
                    </button>
                <Show when=move||{false/*update_error().is_some()*/}>
                    <span>{format!("An Error occured{}", "HI" /*update_error().unwrap()*/)}</span>
                </Show>
